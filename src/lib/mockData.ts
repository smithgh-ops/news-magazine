...
const mockCategories: Category[] = [
  ...
  { id: '7', name: 'Pendidikan', slug: 'pendidikan', description: 'Berita pendidikan dan pembelajaran' },
];
...
const mockArticles: Article[] = [
  {
    ...
    excerpt: 'Pemerintah meluncurkan paket kebijakan komprehensif untuk mendorong pertumbuhan ekonomi digital Indonesia.',
    ...
    featuredImage: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&h=675&fit=crop',
  ...
  },
  {
    ...
    excerpt: 'Perusahaan teknologi lokal berhasil menarik investasi besar dari investor internasional.',
  ...
  },
  {
    ...
    excerpt: 'Pemerintah mengalokasikan 10 triliun rupiah untuk program beasiswa pendidikan berkualitas.',
  ...
  },
  {
    ...
    excerpt: 'KPU mencatat tingkat partisipasi pemilih muda mencapai rekor tertinggi dalam sejarah.',
    content: '<p>Komisi Pemilihan Umum (KPU) melaporkan bahwa tingkat partisipasi pemilih dalam Pemilu 2025 mencapai 87%, tertinggi dalam sejarah demokrasi Indonesia. Peningkatan signifikan terjadi pada kelompok pemilih muda berusia 17-25 tahun.</p><p>Ketua KPU mengapresiasi tingginya kesadaran politik masyarakat dan efektivitas kampanye pendidikan pemilih melalui media sosial. Proses pemungutan suara berjalan lancar dan aman di seluruh TPS, dengan penerapan teknologi e-voting di beberapa wilayah.</p>',
    featuredImage: 'https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=1200&h=675&fit=crop',
  ...
  },
  {
    ...
    content: '<p>Badan Pusat Statistik (BPS) mencatat nilai ekspor produk digital dan jasa teknologi informasi Indonesia mencapai 5 miliar dollar AS pada tahun ini, meningkat 45% dari tahun sebelumnya. Game, aplikasi mobile, dan layanan pengembangan software menjadi kontributor utama.</p><p>Kementerian Perdagangan menyatakan bahwa pemerintah akan terus mendukung pelaku industri digital melalui berbagai program seperti sertifikasi internasional, pendampingan ekspor, dan partisipasi dalam pameran teknologi global.</p>',
